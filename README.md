...
> **This is a fork of [can1357/oh-my-pi](https://github.com/can1357/oh-my-pi)**, extended with BDD-driven development and mechanical auditing standards.
...
|------|-----------------|
| 🛑 `.omp/rules/01-gherkin-enforcer.md` | No code before a Gherkin spec |
| 🛡️ `.omp/rules/02-mechanical-audit.md` | cucumber-js/depcruise/spectral/stryker/npm audit must all pass |
| 🚷 `.omp/rules/03-anti-laziness.md` | Bans `any`, `@ts-ignore`, giant functions, hardcoded secrets |
| 🤖 `.omp/agents/spec.md` | Spec-only subagent (Gherkin/OpenAPI/arch) |
...
cd omp-mc
nano models.env   # edit your preferred models (3 lines)
./install.sh      # applies rules, agents, and model config globally
```

---

<!-- Original oh-my-pi README below -->
